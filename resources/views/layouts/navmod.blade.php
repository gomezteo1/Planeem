...
<div id="form">
		<form method="post"  role="from" action="{{route('update/pensamiento')}}" style="display:none" >
			@csrf
				...
				<input type="text" id="id_Planeacion" name="id_Planeacion"   >
...
<div class="menu_header">
	...
	<nav class="SegundoConten">
		...
		<ul class="items">
			...
			<li ><a><h6>Misión Organizacional</h6><span class="rounded-circle">02</span></a></li>

			<li ><a><h6>Visión Organizacional</h6><span class="rounded-circle">03</span></a></li>

			<li ><a><h6>Mega Empresarial</h6><span class="rounded-circle">04</span> </a></li>

			<li ><a><h6>Valores Corporativos</h6><span class="rounded-circle">05</span></a></li>
		</ul>
